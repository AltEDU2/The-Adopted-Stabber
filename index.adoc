...
pass:q[<form action="https://fogpay.com/payment_api/payment" method="POST"><input type="hidden" name="account_username" value="AltEDU"><span>$ </span><input name="amount" value="0.0"><input type="hidden" name="trans_type" value="payment"><input type="submit" value="Submit Payment"></form>]